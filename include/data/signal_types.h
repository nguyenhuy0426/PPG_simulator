...
struct PPGParameters {
    ...
    float spO2 = 98.0f;                 // SpO2 % (85-100)
    float respRate = 16.0f;             // RR BPM (10-30)
...
enum class UIEditMode : uint8_t {
    ...
    EDIT_SPO2        = 3,       // Up/Down adjusts SpO2
    EDIT_RR          = 4,       // Up/Down adjusts respiratory rate
    EDIT_NOISE       = 5,       // Up/Down adjusts noise level
    
    COUNT            = 6        // Total number of modes
};
