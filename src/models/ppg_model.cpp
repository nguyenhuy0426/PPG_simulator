    ...
    switch (params.condition) {
        case PPGCondition::NORMAL:
            ...
            condRanges = {
                ...
                .diastolicAmpl = 0.4f,      //Allen base (d/s 0.4)
                .dicroticDepth = 0.25f      //Subtle notch ≥20%
            };
            break;
        ...
        case PPGCondition::STRONG_PERFUSION:
            ...
            condRanges = {
                ...
                .systolicAmpl = 1.0f,       //Allen Base
                .diastolicAmpl = 0.6f,      //Increased (prominent vascular reflex)
                .dicroticDepth = 0.35f      //≥30%, prominent
            };
            break;
        ...
        case PPGCondition::VASODILATION:
            ...
            condRanges = {
                ...
                .dicroticDepth = 0.30f      //20-40%, more marked
            };
            break;
